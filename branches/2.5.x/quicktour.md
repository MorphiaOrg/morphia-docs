...
The following code snippets come from the [QuickTourTest.java](https://github.com/MorphiaOrg/morphia/tree/2.5.x/examples/src/test/java/dev/morphia/example/QuickTourTest.java)
