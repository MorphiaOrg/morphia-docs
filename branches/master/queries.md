...
Borrowing from the
[unit tests](https://github.com/MorphiaOrg/morphia/tree/master/core/src/test/java/dev/morphia/TestQuery.java), this is an example of this feature in action:
...
[unit tests](https://github.com/MorphiaOrg/morphia/tree/master/core/src/test/java/dev/morphia/TestQuery.java) in the `testTailableCursors()` test:
