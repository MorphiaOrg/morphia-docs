...
> **Deprecated:** This page documents the legacy `MapperOptions`-based configuration from Morphia 2.0. See [Configuration](../configuration/) for the current configuration approach.
...
`@Property` annotation.
In 2.0, however, naming strategies were introduced.
...
You can register your custom `CodecProvider` implementation via [MapperOptions.Builder#codecProvider()](javadoc/dev/morphia/mapping/MapperOptions.Builder.html).
