...
This old API is active using the [legacy configuration](../configuration/#_legacy).
The new API will attempt to redirect most calls to use the new [Filters](javadoc/dev/morphia/query/filters/Filters.html) based approach.
...
In this case, the condition is assumed to be an [equality](https://docs.mongodb.com/manual/reference/operator/query/eq/) check.
...
In this case, we're instructing Morphia to add a filter using [$gte](https://docs.mongodb.com/manual/reference/operator/query/gte/).
...
[FilterOperator](https://github.com/MorphiaOrg/morphia/tree/2.4.x/morphia/src/main/java/dev/morphia/query/FilterOperator.java) class.
...
This method takes only the field name and returns an instance of a [class](https://github.com/MorphiaOrg/morphia/tree/2.4.x/morphia/src/main/java/dev/morphia/query/FieldEnd.java) providing methods with which to define your filters.
...
[@Property](javadoc/dev/morphia/annotations/Property.html) annotation on the field.
...
[test](https://github.com/MorphiaOrg/morphia/tree/2.4.x/morphia/src/test/java/dev/morphia/query/TestTextSearching.java) does:
...
Borrowing from the
[unit tests](https://github.com/MorphiaOrg/morphia/tree/2.4.x/morphia/src/test/java/dev/morphia/TestQuery.java), this is an example of this feature in action:
...
[unit tests](https://github.com/MorphiaOrg/morphia/tree/2.4.x/morphia/src/test/java/dev/morphia/TestQuery.java) in the `testTailableCursors()` test:
