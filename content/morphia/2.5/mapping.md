...
{{< admonition type="warning" title="Warning" >}}
Method-based mapping is new in 2.2. While testing has been done to ensure everything works the same as with fields, there may be some esoteric combinations of features that reveal a gap in functionality.
