...
[FilterOperator](https://github.com/MorphiaOrg/morphia/tree/2.5.x/morphia/src/main/java/dev/morphia/query/FilterOperator.java) class.
...
This method takes only the field name and returns an instance of a [class](https://github.com/MorphiaOrg/morphia/tree/2.5.x/morphia/src/main/java/dev/morphia/query/FieldEnd.java) providing methods with which to define your filters.
...
[test](https://github.com/MorphiaOrg/morphia/tree/2.5.x/morphia/src/test/java/dev/morphia/query/TestTextSearching.java) does:
...
Borrowing from the
[unit tests](https://github.com/MorphiaOrg/morphia/tree/2.5.x/morphia/src/test/java/dev/morphia/TestQuery.java), this is an example of this feature in action:
...
[unit tests](https://github.com/MorphiaOrg/morphia/tree/2.5.x/morphia/src/test/java/dev/morphia/TestQuery.java) in the `testTailableCursors()` test:
