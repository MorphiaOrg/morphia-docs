---
title: "Updating (Legacy)"
weight: 40
---

{{< admonition type="warning" title="Warning" >}}
This page documents the legacy update API that was removed in Morphia 3.0.
It is preserved here for users migrating from 2.x.
For the current update API, see [Updates](../updates/).
{{< /admonition >}}
...
The update method on [Datastore](javadoc/dev/morphia/Datastore.html) is used to issue a command to the server to change existing documents.
The effects of the update command are defined via
[UpdateOperations](javadoc/dev/morphia/query/UpdateOperations.html) methods.
...
[PushOptions](javadoc/dev/morphia/query/PushOptions.html) instance allowing for tweaking how the values are added to the list.
See [the manual](https://docs.mongodb.com/manual/reference/operator/update/push/#modifiers) for more information about the various modifiers available.
